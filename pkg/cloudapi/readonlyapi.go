...
func NewReadOnlyAPIService(region string, rate int, credential common.CredentialIface, internetEndpoint bool) *readonlyAPIService {
	apiService := NewTencentAPIService(region, rate, credential, internetEndpoint)
